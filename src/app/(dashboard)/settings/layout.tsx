...
import { Radio, Users, Tags, Bell, Building2, KeyRound, Sparkles, BookUser, BookOpen, Facebook, ListChecks, Upload, Copy, Shield, Plug, Shuffle } from 'lucide-react';
...
const tabs = [
  ...
  { href: '/settings/groups', label: 'Grupos', icon: Shield },
